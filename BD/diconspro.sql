...
-- Volcando estructura de base de datos para diconspro
CREATE DATABASE IF NOT EXISTS `diconspro` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `diconspro`;

-- Volcando estructura para tabla diconspro.balance
CREATE TABLE IF NOT EXISTS `balance` (
  `bal_id` int(11) NOT NULL AUTO_INCREMENT,
  `bal_cotizacion` varchar(500) DEFAULT NULL,
  `bal_deuda` varchar(500) DEFAULT NULL,
  `bal_proveedor` varchar(500) DEFAULT NULL,
  `bal_porcentaje` varchar(500) DEFAULT NULL,
  `bal_ingresos` varchar(500) DEFAULT NULL,
  `bal_total` varchar(500) DEFAULT NULL,
  `bal_sesenta` varchar(500) DEFAULT NULL,
  `bal_cuarenta` varchar(500) DEFAULT NULL,
  `bal_estado` varchar(500) DEFAULT NULL,
  `bal_fechac` date DEFAULT curdate(),
  `bal_horac` time DEFAULT curtime(),
  `bal_usuc` varchar(500) DEFAULT NULL,
  `bal_fecham` date DEFAULT NULL,
  `bal_horam` time DEFAULT NULL,
  PRIMARY KEY (`bal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.balance: ~8 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.cliente
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `cli_fechac` date DEFAULT curdate(),
  `cli_horac` time DEFAULT curtime(),
...
-- Volcando datos para la tabla diconspro.cliente: ~10 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.cotizacion
CREATE TABLE IF NOT EXISTS `cotizacion` (
  `cot_id` int(11) NOT NULL AUTO_INCREMENT,
  `cot_nombre` varchar(100) DEFAULT NULL,
  `cot_tipocot` varchar(100) DEFAULT NULL,
  `cot_tipo` varchar(100) DEFAULT NULL,
  `cot_recono` varchar(100) DEFAULT NULL,
  `cot_pisos` varchar(100) DEFAULT NULL,
  `cot_obranue` varchar(100) DEFAULT NULL,
  `cot_prophori` varchar(100) DEFAULT NULL,
  `cot_suelos` varchar(100) DEFAULT NULL,
  `cot_arquit` varchar(100) DEFAULT NULL,
  `cot_metro2` varchar(100) DEFAULT NULL,
  `cot_valortot` varchar(100) DEFAULT NULL,
  `cot_estado` varchar(1) DEFAULT NULL,
  `cot_tradicion` varchar(100) DEFAULT NULL,
  `cot_curaduria` varchar(100) DEFAULT NULL,
  `cot_vecinos` varchar(100) DEFAULT NULL,
  `cot_descuento` varchar(100) DEFAULT NULL,
  `cot_estructural` varchar(100) DEFAULT NULL,
  `cot_arquitectonico` varchar(100) DEFAULT NULL,
  `cot_cliente` varchar(100) DEFAULT NULL,
  `cot_cantveci` varchar(100) DEFAULT NULL,
  `cot_lineaparam` varchar(100) DEFAULT NULL,
  `cot_vlrparam` varchar(100) DEFAULT NULL,
  `cot_fechac` date DEFAULT curdate(),
  `cot_horac` time DEFAULT curtime(),
  `cot_usuarioc` varchar(100) DEFAULT NULL,
  `cot_usuariom` varchar(100) DEFAULT NULL,
  `cot_fecham` varchar(100) DEFAULT NULL,
  `cot_horam` varchar(100) DEFAULT NULL,
  `cot_proyecto` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`cot_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.cotizacion: ~5 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.departamentos
...
-- Volcando datos para la tabla diconspro.departamentos: ~33 rows (aproximadamente)
...
-- Volcando estructura para tabla diconspro.descripcion
CREATE TABLE IF NOT EXISTS `descripcion` (
  `des_codigo` int(11) NOT NULL AUTO_INCREMENT,
  `pro_codigo` int(11) DEFAULT 0,
  `des_text` text DEFAULT NULL,
  `des_usuario` varchar(500) DEFAULT NULL,
  `des_fechac` date DEFAULT curdate(),
  `des_horac` time DEFAULT curtime(),
  PRIMARY KEY (`des_codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.descripcion: ~0 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.menu
...
-- Volcando datos para la tabla diconspro.menu: ~4 rows (aproximadamente)
INSERT INTO `menu` (`men_id`, `men_menu`, `men_submen`, `men_menurl`, `men_suburl`, `men_estado`) VALUES
	(1, 'Inicio', NULL, 'inicio', NULL, 1),
	(2, 'Modulos', 'usuarios,clientes,roles,cotizacion,proyectos,precios', NULL, 'usuarios,clientes,roles,cotizacion,proyectos,precios', 1),
	(4, NULL, NULL, 'salir', NULL, 1),
	(5, 'Finanzas', 'Balance', NULL, 'balance', 1);

-- Volcando estructura para tabla diconspro.municipios
...
-- Volcando datos para la tabla diconspro.municipios: ~1.100 rows (aproximadamente)
...
-- Volcando estructura para tabla diconspro.proyecto
CREATE TABLE IF NOT EXISTS `proyecto` (
  `pro_codigo` int(11) NOT NULL AUTO_INCREMENT,
  `pro_nombre` varchar(500) NOT NULL DEFAULT '0',
  `pro_cotizacion` varchar(10000) DEFAULT NULL,
  `pro_estado` varchar(1) DEFAULT NULL,
  `pro_usuario` varchar(10) DEFAULT NULL,
  `pro_usuc` varchar(200) DEFAULT NULL,
  `pro_autocat` text DEFAULT NULL,
  `pro_certiftradi` text DEFAULT NULL,
  `pro_escritura` text DEFAULT NULL,
  `pro_fotovaya` text DEFAULT NULL,
  `pro_impredial` text DEFAULT NULL,
  `pro_otroarch` text DEFAULT NULL,
  `pro_foto1` text DEFAULT NULL,
  `pro_foto2` text DEFAULT NULL,
  `pro_foto3` text DEFAULT NULL,
  `pro_foto4` text DEFAULT NULL,
  `pro_foto5` text DEFAULT NULL,
  `pro_foto6` text DEFAULT NULL,
  `pro_fechaini` date DEFAULT NULL,
  `pro_estimado` date DEFAULT NULL,
  `pro_fechafin` date DEFAULT NULL,
  `pro_fechac` date DEFAULT curdate(),
  `pro_horac` time DEFAULT curtime(),
  `pro_descripcion` text DEFAULT NULL,
  PRIMARY KEY (`pro_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.proyecto: ~4 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.roles
...
-- Volcando datos para la tabla diconspro.roles: ~5 rows (aproximadamente)
INSERT INTO `roles` (`rol_id`, `rol_nombre`, `rol_fechac`, `rol_estado`) VALUES
	(1, 'admin', '2022-06-09', 1),
	(2, 'dibujante', '2022-06-09', 1),
	(7, 'servicios generales', NULL, 1),
	(9, 'Contador', NULL, 1),
	(10, 'cafeteria', NULL, 1);

-- Volcando estructura para tabla diconspro.usuario
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `usu_fechac` date DEFAULT curdate(),
  `usu_ultmlog` datetime DEFAULT NULL,
  `usu_horac` time DEFAULT curtime(),
...
-- Volcando datos para la tabla diconspro.usuario: ~3 rows (aproximadamente)
INSERT INTO `usuario` (`usu_codigo`, `usu_cuenta`, `usu_pass`, `usu_nombre`, `usu_apellido`, `usu_telefono`, `usu_email`, `usu_foto`, `usu_rol`, `usu_estado`, `usu_fechac`, `usu_ultmlog`, `usu_horac`, `usu_fecham`, `usu_horam`, `usu_ipcone`, `usu_paiscone`) VALUES
	(5, 'juan', '$2y$10$PNxSusCZ6dI1mryDfIGSyOBavZR5p3LmKAO40B.jiUAOFP0QXkDfe', 'Juan pablo', 'Paz valencia', '2147483647', 'juan@email.com', 'img/usuarios/juan/juan.png', 1, '1', '2022-06-11', '2022-07-31 17:35:36', '00:45:38', NULL, NULL, NULL, NULL),
	(30, 'andres', '$2y$10$H9KW4Yb9fBOyb.TQRmext.paRbgg3eLKX..3Z2FokjON8Mgq45SIe', 'andres', 'mosquera', '3187401935', 'andres@gmail.com', 'img/usuarios/andres/andres.png', 1, '1', '2022-06-11', '2022-07-29 22:43:24', '13:53:27', NULL, NULL, NULL, NULL),
	(34, 'erika', '$2y$10$JmMk0zZnkx2TFfFwfceL9.GLhEkzKe4KfGNW3QyMYaDzQKPPQ3az2', 'erika ', 'velez', '3187401935', 'jaimehus@email.com', 'img/usuarios/erika/erika.png', 2, '1', '2022-07-20', '2022-07-31 17:30:49', '18:42:03', NULL, NULL, NULL, NULL),
	(35, 'admin', '$2y$10$kw3qNlu/WEi.Q6Mr/TjK8OaqG8DtNkeKP0D.VSmJwm9vVebehmPEW', 'administrador', '', '74587999', 'admin@gmail.com', 'img/usuarios/admin/admin.png', 1, '1', '2022-07-31', '2022-07-31 14:48:50', '14:47:37', NULL, NULL, NULL, NULL);

-- Volcando estructura para tabla diconspro.valores_cotizacion
CREATE TABLE IF NOT EXISTS `valores_cotizacion` (
  `valor_id` int(11) NOT NULL AUTO_INCREMENT,
  `valor_arquite` int(50) DEFAULT 0,
  `valor_proyecto` int(50) DEFAULT 0,
  `valor_prohori` int(50) DEFAULT 0,
  `valor_levant` int(50) DEFAULT 0,
  `valor_suelos` int(50) DEFAULT 0,
  `valor_tradicion` int(50) DEFAULT 0,
  `valor_curaduria` int(50) DEFAULT 0,
  `valor_vecinos` int(50) DEFAULT 0,
  `valor_aporticado` int(50) DEFAULT 0,
  `valor_confinado` int(50) DEFAULT 0,
  `valor_ano` varchar(50) DEFAULT NULL,
  `valor_fechac` date DEFAULT curdate(),
  `valor_horac` time DEFAULT curtime(),
  `valor_usuac` varchar(50) DEFAULT NULL,
  `valor_usuam` varchar(50) DEFAULT NULL,
  `valor_gastos` int(11) DEFAULT NULL,
  PRIMARY KEY (`valor_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.valores_cotizacion: ~0 rows (aproximadamente)
INSERT INTO `valores_cotizacion` (`valor_id`, `valor_arquite`, `valor_proyecto`, `valor_prohori`, `valor_levant`, `valor_suelos`, `valor_tradicion`, `valor_curaduria`, `valor_vecinos`, `valor_aporticado`, `valor_confinado`, `valor_ano`, `valor_fechac`, `valor_horac`, `valor_usuac`, `valor_usuam`, `valor_gastos`) VALUES
	(1, 3500, 480000, 4000, 1500, 950000, 17800, 50000, 5000, 4100, 3500, '2022', '2022-06-17', '23:27:22', NULL, NULL, 3180000);

-- Volcando estructura para tabla diconspro.vlr_company
CREATE TABLE IF NOT EXISTS `vlr_company` (
  `vlr_id` int(11) NOT NULL AUTO_INCREMENT,
  `vlr_valor` varchar(500) DEFAULT NULL,
  `vlr_cotizacion` varchar(500) DEFAULT NULL,
  `vlr_proyecto` varchar(500) DEFAULT NULL,
  `vlr_fechac` date DEFAULT curdate(),
  `vlr_horac` time DEFAULT curtime(),
  PRIMARY KEY (`vlr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.vlr_company: ~8 rows (aproximadamente)

-- Volcando estructura para tabla diconspro.vlr_paramentos
CREATE TABLE IF NOT EXISTS `vlr_paramentos` (
  `vlr_codigo` int(11) NOT NULL AUTO_INCREMENT,
  `vlr_rangoini` varchar(50) DEFAULT NULL,
  `vlr_rangofin` varchar(50) DEFAULT NULL,
  `vlr_valor` varchar(50) DEFAULT NULL,
  `vlr_estampilla` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`vlr_codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla diconspro.vlr_paramentos: ~4 rows (aproximadamente)
INSERT INTO `vlr_paramentos` (`vlr_codigo`, `vlr_rangoini`, `vlr_rangofin`, `vlr_valor`, `vlr_estampilla`) VALUES
	(1, '1', '2', '50000', '14000'),
	(2, '3', '4', '83000', '14000'),
	(3, '5', '6', '150000', '14000'),
	(4, '7', '999', '167000', '14000');
